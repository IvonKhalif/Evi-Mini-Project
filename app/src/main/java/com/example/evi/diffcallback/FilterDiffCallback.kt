...
class FilterDiffCallback(private val mOldList: List<Features>,
    ...
    override fun areContentsTheSame(oldItemPosition: Int, newItemPosition: Int): Boolean {
        return mOldList[oldItemPosition].attributes!!.Provinsi == mNewList[newItemPosition].attributes!!.Provinsi
    }
}